class DepartamentosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @departamento.save
        format.html { redirect_to @departamento, flash: { success: 'Departamento was successfully created.' } }
  ...
  def update
    respond_to do |format|
      if @departamento.update(departamento_params)
        format.html { redirect_to @departamento, flash: { success: 'Departamento was successfully updated.' } }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to departamentos_url, flash: { success: 'Departamento was successfully destroyed.' } }
